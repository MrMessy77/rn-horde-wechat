...
Pod::Spec.new do |s|
  ...
  React-Native(iOS/Android) functionalities include WeChat Login, Share, Favorite and Payment
   DESC
  s.author       = { "rn-horde-wechat" => "313691730@qq.com" }
  s.homepage     = "https://github.com/MrMessy77/rn-horde-wechat"
  s.license      = "MIT"
  s.platform     = :ios, "9.0"
  s.source       = { :git => "https://github.com/MrMessy77/rn-horde-wechat.git", :tag => "master" }
